    ...
    <section className="bg-gradient-to-br from-gray-50 to-white py-12 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex items-center bg-yellow-100 text-yellow-700 px-3 py-1 rounded-full text-xs font-medium">
        ...
        <div className="grid lg:grid-cols-10 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <motion.p 
              ...
              className="text-2xl sm:text-3xl font-medium text-green-500"
            >
              Just in 1 Click
            </motion.p>
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg font-semibold text-lg shadow-lg transition-all duration-200"
              >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="border-2 border-gray-300 hover:border-green-500 text-gray-700 hover:text-green-500 px-8 py-4 rounded-lg font-semibold text-lg transition-colors duration-200"
              >
                Check Today Offers →
              </motion.button>
            </motion.div>
